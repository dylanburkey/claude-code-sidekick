...
```
❌ Error: No configuration found for "custom-mcp"
...
```
⚠️  Warning: Missing environment variables for enabled MCPs
...
```
⚠️  Warning: Package not found: @custom/mcp-server
...
✓ All enabled MCPs have configurations
✓ Environment variables documented
⚠ Missing .env file (using .env.example as reference)
